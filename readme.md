...
If you use [`demo.ipynb`](demo.ipynb), you must download the [nuScenes dataset](https://www.nuscenes.org/nuimages#download) first. Ensure that `DATA_ROOT` is updated to the path where your dataset is stored.
